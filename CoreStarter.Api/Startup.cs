...
using System.Linq;
using System.Text;
using WebAPITemplate.Api.Configuration;
using WebAPITemplate.Api.Middleware;
using WebAPITemplate.Api.Services;
using WebAPITemplate.Api.SwaggerExamples;
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            services
                .AddMvc(
                    options =>
                    {
                        // More Info on how to properly set the caching 
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Version = "v1",
                    Title = ".NET Core Web API Starter Template",
                    Description = ".NET Core Web API Starter Template",
                    TermsOfService = "None",
                    
                    //Included your Company email and contact name here for the API Page(Displayed publicly)
                    Contact = new Contact { Name = "Company Name", Email = "email@gmail.com", Url = "" }
                });
