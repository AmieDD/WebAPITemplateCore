/*
 * Developer: Amie Dansby
 * Date 11/19/2018
 * Description: Controller for the Web API (Controller has to be at the end of the name for the class file, ie FooController.cs)
 */
using System;
using System.Collections.Generic;
using System.IO;
using System.Threading.Tasks;
using WebAPITemplate.Api.Binders;
